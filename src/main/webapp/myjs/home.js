...
$(document).ready(function () {
    $.get("http://ljx520.cn//blog/typenumber/map",
 ...
 $.get("http://ljx520.cn/blogs/number/sum",
        function (data, status) {
...
function serch() {
    ...
    $("input#myserch").bind("input propertychange", function (e) {
        ...
        var ourl = "http://ljx520.cn/blogs/" + text;
...
function aa(start) {
    ...
    $.get("http://ljx520.cn/blogs/get10/0",
        function (data, status) {
            var bloss = "";
            for (var index = 0; index < data.length; index++) {
                var element = data[index];
...
function geturlfor_blog(blogid) {
    return '<a href="' +
        'http://ljx520.cn/post.html"' + '  title="' + blogid + '"' + '" class="portfolio-box" >';
}
...
function moredown() {
    ...
    var ourl = "http://ljx520.cn/blogs/get10/" + text;
...
function getbloghtml22(blog) {
    ...
    html+=' <a href="http://ljx520.cn/post.html" class="myaaaaa2" ';
    html+=' title="'+blog["id"]+'" >';
...
var ourl="http://ljx520.cn/blogs/type/"+id;
