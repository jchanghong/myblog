...
$(document).ready(function () {
    $.get("http://localhost//blog/typenumber/map",
 ...
 $.get("http://localhost/blogs/number/sum",
        function (data, status) {
...
function serch() {
    ...
    $("input#myserch").bind("input propertychange", function (e) {
        ...
        var ourl = "http://localhost/blogs/" + text;
...
function aa(start) {
    ...
    $.get("http://localhost/blogs/get10/0",
        function (data, status) {
            var bloss = "";
            for (var index = 0; index < data.length; index++) {
                var element = data[index];
...
function geturlfor_blog(blogid) {
    return '<a href="' +
        'http://localhost/post.html"' + '  title="' + blogid + '"' + '" class="portfolio-box" >';
}
...
function moredown() {
    ...
    var ourl = "http://localhost/blogs/get10/" + text;
...
function getbloghtml22(blog) {
    ...
    html+=' <a href="http://localhost/post.html" class="myaaaaa2" ';
    html+=' title="'+blog["id"]+'" >';
...
var ourl="http://localhost/blogs/type/"+id;
